...
1. Open a browser window and navigate to:
    ...
    ```bash
    http://gogs.apps.tampa-6f59.openshiftworkshop.com/
    ```
...
1. Copy the browser tab URL. Store that URL address as you will use it in the next steps of the lab. The URL should look like the following:
    ...
    ```bash
     http://gogs.apps.tampa-6f59.openshiftworkshop.com/userX/locations-api/raw/dev-track-lab-02/locations-api/Locations-userX.json
    ```
...
1. Open a browser window and navigate to:
    ...
    ```bash
    http://microcks.apps.tampa-6f59.openshiftworkshop.com/
    ```
...
1. In the `Create a New Job` dialog, type in the following information replacing **X** with your user number. Click **Next**.
    ...
    * Repository URL: **http://gogs.apps.tampa-6f59.openshiftworkshop.com/userX/locations-api/raw/dev-track-lab-02/locations-api/Locations-userX.json**
...
1. Copy and paste the Mock URL from earlier step. It should look like this:
   ...
   *Remember to replace X with your user number*.
    ...
    ```bash
    http://microcks.apps.tampa-6f59.openshiftworkshop.com/rest/Locations-userX/1.0.0/locations
    ```
