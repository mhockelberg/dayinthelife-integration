...
```bash
https://location-service-api.amp.apps.littleton-eedb.openshiftworkshop.com
```
...
1. Scroll back to the top of the page. Fill in the information for accessing your API:
    ...
    * Staging Public Base URL: **https://location-userX-api-staging.amp.apps.littleton-eedb.openshiftworkshop.com:443**

    * Production Public Base URL: **https://location-userX-api.amp.apps.littleton-eedb.openshiftworkshop.com:443**
