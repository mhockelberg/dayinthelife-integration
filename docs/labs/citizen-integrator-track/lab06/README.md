...
1. Open your OpenShift web console by navigating to `https://master.littleton-eedb.openshiftworkshop.com/console/catalog`. Navigate to your project's overview page. It will be called `UserX Project` (replacing X with your username).
...
*Example link: `https://location-userX-api-staging.amp.apps.littleton-eedb.openshiftworkshop.com/locations`*
