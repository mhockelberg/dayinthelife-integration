...
1. Open your OpenShift web console by navigating to `https://master.tampa-6f59.openshiftworkshop.com/console/catalog`. Navigate to your project's overview page. It will be called `UserX Project` (replacing X with your username).
...
*Example link: `https://location-userX-api-staging.amp.apps.tampa-6f59.openshiftworkshop.com/locations`*
