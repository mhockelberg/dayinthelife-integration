...
```bash
https://location-sso.amp.apps.tampa-6f59.openshiftworkshop.com:443
```
...
1. Open a browser window and navigate to:
    ...
    ```bash
    https://sso-sso.apps.tampa-6f59.openshiftworkshop.com/auth/admin/userX/console
    ```
...
1. In the **OpenID Connect Issuer** field, type in your previously noted client credentials with the URL of your Red Hat Single Sing On instance:
    ...
    ```bash
    https://3scale-admin:CLIENT_SECRET@sso-sso.apps.tampa-6f59.openshiftworkshop.com/auth/realms/userX
    ```
...
1. Update the **Redirect URL** to http://www-userX.apps.tampa-6f59.openshiftworkshop.com/*. And note the *API Credentials*. Write them down as you will need the **Client ID** and the **Client Secret** to test your integration.
